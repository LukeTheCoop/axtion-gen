...
# Create an instance of ConfigService directly
...
@router.get("/music")
async def get_music_config() -> Dict[str, Any]:
...
@router.get("/output")
async def get_output_config() -> Dict[str, Any]:
...
async def update_audio_config(
    ...
    # Update audio generator configuration
    audio_processor = AudioProcessorService(config_service)
    audio_processor.update_audio_generator_config()
